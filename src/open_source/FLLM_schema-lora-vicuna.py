...
parser.add_argument("--log_name", type=str, default='/common/home/zl359/OpenAGI/automata_log/vicuna_3.txt')
parser.add_argument("--ckp_dir", type=str, default='/common/home/zl359/OpenAGI/checkpoint/vicuna_automata_3/')
...
print(test_task_idx, berts, np.mean(berts[:-4]), np.mean(rewards[:-4]), np.mean(berts[-4:]))
